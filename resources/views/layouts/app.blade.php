                ...
                <div class="flex-grow flex flex-wrap md:pl-20 -mb-10 md:mt-0 mt-10 md:text-left text-center">
                    ...
                    <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <div class="flex flex-wrap justify-center items-end md:justify-start">
                            <div class="relative w-40 sm:w-auto lg:mr-0 sm:mr-4 mr-2">
                            ...
                            <button class="md:mt-1 lg:mt-2 flex-shrink-0 inline-flex text-white bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded">Subscribe</button>
                        </div>
                        <p class="text-gray-500 text-sm mt-2 md:text-left text-center">Dapatkan informasi terupdate dari Quick</p>
                    </div>
                </div>
            </div>
