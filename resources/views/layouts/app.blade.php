...
<html>
    ...
    <body>
        ...
        <footer class="text-gray-600 body-font">
            <div class="w-11/12 px-5 py-24 mx-auto">
                    ...
                    <div class="lg:w-1/4 md:w-1/2 w-full px-4">
                        ...
                        <div
                            ...
                            <div class="relative w-40 sm:w-auto xl:mr-4 lg:mr-0 sm:mr-4 mr-2">
                                <input type="text" id="footer-field" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-blue-200 focus:border-blue-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            <button
            ...
            <div class="bg-gray-100">
                <div class="container px-4 py-6 mx-auto flex items-center sm:flex-row flex-col">
                    <p class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">© 2022 Quick — All rights reserved.
                    </p>
